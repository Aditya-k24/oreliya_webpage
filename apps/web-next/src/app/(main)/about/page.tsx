    ...
    <div className='bg-white'>
      ...
      <div className='max-w-7xl mx-auto px-6 lg:px-8 py-20 text-center'>
        ...
        <div className='flex flex-col sm:flex-row gap-4 justify-center'>
          <a
            href='/customization'
            className='px-8 py-4 bg-[#1E240A] text-white font-medium rounded-none hover:bg-[#2A3A1A] transition-colors uppercase tracking-wider text-sm'
          >
            Start Custom Design
          </a>
          <a
            href='/contact'
            className='px-8 py-4 border-2 border-[#1E240A] text-[#1E240A] font-medium rounded-none hover:bg-[#1E240A] hover:text-white transition-all uppercase tracking-wider text-sm'
          >
            Contact Us
          </a>
        </div>
