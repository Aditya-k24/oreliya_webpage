...
const products: any[] = [
  ...
  },
  {
    ...
    price: 45000,
    category: 'Necklace',
    subcategory: 'Everyday Necklaces',
  ...
  },
  {
    ...
    category: 'Bracelet',
    subcategory: null,
    images: ['/images/categories/bracelet.png'],
    inStock: true,
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
  },
  {
    id: '6',
    name: 'Vintage Eira Collection Ring',
    description: 'Beautiful vintage-inspired ring from our Eira Collection.',
    price: 75000,
    category: 'Eira Collection',
    subcategory: null,
    images: ['/images/categories/era_ring.png'],
    inStock: true,
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
  },
